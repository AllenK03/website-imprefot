                    ...
                    <div class="flex flex-col sm:flex-row gap-4 p-5 bg-gray-50 rounded-3xl border border-gray-100 hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col justify-between flex-grow">
                            ...
                            <div class="mt-5">
                                ...
                                target="_blank" 
                                class="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-[#25D366] text-white px-8 py-4 rounded-2xl text-sm font-black uppercase tracking-tighter hover:bg-[#20ba5a] hover:scale-[1.02] transition-all shadow-lg active:scale-95 cursor-pointer group">
